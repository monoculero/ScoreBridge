...
2. **RetroArch** configured with the necessary core --> fbneo_libretro.dll (https://www.retroarch.com/).
3. **Attract-Mode Plus** as a gaming frontend (https://github.com/oomek/attractplus).
4. **An active iScored account** with your games created in your Gameroom (https://www.iscored.info/faq.php) using `[]` with the rom game --> `Super Pang [spang]`.
